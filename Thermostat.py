...
class TemperatureMachine(StateMachine):
    ...
    def setupSerialOutput(self):
        ...
        outputString = f"{self.current_state.id},{temp},{self.setPoint}"
        # convert output string to binary
        output = outputString.encode()
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                lcd_line_2 = f"Current Temp: {floor(self.getFahrenheit())}"
...
##
greenButton = Button(12, bounce_time=0.2)
...
##
redButton = Button(2, bounce_time=0.2)
...
##
blueButton = Button(25, bounce_time=0.2)
